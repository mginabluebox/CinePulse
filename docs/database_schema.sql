...
\restrict uEsUp7wgQ8f9uFWoiLxiVZjK5RmrwoLjKXfDiQ09pixvNHodCfE5hUWxG0mXEdb
...
CREATE TABLE public.movies (
    ...
    created_at timestamp without time zone DEFAULT now() NOT NULL,
    updated_at timestamp without time zone DEFAULT now() NOT NULL,
    scraped_synopsis text,
    scraped_director1 character varying(255),
    scraped_cinema text,
    embedding public.vector(1536),
    embedding_model text,
    embedded_at timestamp with time zone,
    embedding_source_hash character(64),
    scraped_image_url text,
    scraped_details_link text,
    imdb_id text,
    tmdb_id integer,
    imdb_rating numeric(3,1),
    imdb_votes integer,
    omdb_rt_score integer,
    omdb_metacritic_score integer,
    tmdb_original_title text,
    tmdb_genres text[],
    tmdb_origin_countries text[],
    ...
    tmdb_trailer_url text,
    tmdb_title_zh text,
    enriched_at timestamp without time zone,
    scraped_title_normalized text
);
...
--
-- Name: recommendation_feedback_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
ALTER TABLE public.recommendation_logs ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.recommendation_logs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.showtimes (
    ...
    show_day character varying(20) NOT NULL,
    ticket_link text,
    director1 character varying(255),
    director2 character varying(255),
    year integer,
    runtime integer,
    format character varying(50) DEFAULT 'UNKNOWN'::character varying NOT NULL,
    synopsis text,
...
--
-- Name: recommendation_feedback id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: showtimes uq_showtimes_movie_time_cinema_format; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.showtimes
    ADD CONSTRAINT uq_showtimes_movie_time_cinema_format UNIQUE (movie_id, show_time, cinema, format);
...
--
-- Name: idx_recommendation_logs_api_name; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_recommendation_logs_api_name ON public.recommendation_logs USING btree (api_name);


--
-- Name: idx_recommendation_logs_queried_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_recommendation_logs_queried_at ON public.recommendation_logs USING btree (queried_at DESC);


--
-- Name: idx_showtimes_movie_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: uq_idx_movies_title_year; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_idx_movies_title_year ON public.movies USING btree (lower(TRIM(BOTH FROM title)), year);
...
--
-- Name: showtimes fkey_showtimes_movie_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.showtimes
    ADD CONSTRAINT fkey_showtimes_movie_id FOREIGN KEY (movie_id) REFERENCES public.movies(id) ON DELETE RESTRICT;
...
\unrestrict uEsUp7wgQ8f9uFWoiLxiVZjK5RmrwoLjKXfDiQ09pixvNHodCfE5hUWxG0mXEdb
